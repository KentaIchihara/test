drop function rfmrank(date0 varchar(10));
create or replace function rfmrank(date0 varchar(10)) returns table(rfm_rank text, count bigint) AS $$
with x as (
...
select * from rfmrank('2017-12-20');
