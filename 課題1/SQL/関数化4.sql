drop function rfmrank_tran2(date1 varchar(10), date2 varchar(10));
create or replace function rfmrank_tran2(date1 varchar(10), date2 varchar(10)) returns table(user_id varchar(10), date1 date, date2 date, transition text) AS $$
...
select
  f2.user_id, date(date1), date(date2),
  (rfm_rank1 ||'¨'|| rfm_rank2) as transition
--  ,count(*)
from f1
...
select * from rfmrank_tran2('2015-12-20', '2016-12-20');
